...
var style_3400900009_14 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_3400900009_14_eval_expression(context) !== null) {
        labelText = String(exp_label_3400900009_14_eval_expression(context));
    }
